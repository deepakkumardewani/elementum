...
const ROW_DEFS: RowDef[] = [
  ...
  { label: "Van der Waals Radius", unit: "pm",   isNumeric: true,  getValue: (el) => el.vanDerWaalsRadius ?? null },
  { label: "Thermal Conductivity", unit: "W/(m·K)", isNumeric: true, getValue: (el) => el.thermalConductivity ?? null },
  { label: "Mohs Hardness",     unit: "Mohs",    isNumeric: true,  getValue: (el) => el.mohsHardness ?? null },
  { label: "Crystal Structure", isNumeric: false, getValue: (el) => el.crystalStructure ?? null },
