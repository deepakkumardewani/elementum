...
function plainTextAfterRemovingMatches(query: string, matches: SegmentMatch[]): string {
  let result = query
...
export function removeSearchTokenFromQuery(query: string, rawToken: string): string {
...
export function elementMatchesAdvancedTokens(el: Element, tokens: ParsedSearchToken[]): boolean {
