...
- Configure SPA redirect rule (all routes → `index.html`)
- Run Lighthouse one final time on the deployed URL — scores must be ≥ 90 for Performance and Accessibility
